...
const ListPost = () => {
  ...
  const addPost=()=>{
    ...
    let newArray = [...listPost,newPost];
    setListPost(newArray);
    setContent("");
    setTitle("");
    setCategory("");
  }
  ...
  const deletePost = (id) =>{
    ...
    let newArray = listPost.filter(element =>{
  ...
  const editPost = (id) =>{
    ...
    let newListPost = listPost.map(element =>{
        if(element.id === id){
            return {
                ...element,...editPost
            }
  ...
  return (
    <>
      ...
      <h1>Create and edit post</h1>
      <table>
        <tr>
            <td>Title</td>
            <td><input type="text" id="title" value={title} onChange={(event) =>inputTitle(event.target.value)}></input></td>
        </tr>
        <tr>
            <td>Category</td>
            <td><input type="text" id="category" value={category} onChange={(event) =>inputCategory(event.target.value)}></input></td>
        </tr>
        <tr>
            <td>Content</td>
            <td><input type="text" id="content" value={content} onChange={(event) =>inputContent(event.target.value)}></input></td>
        </tr>
